...
public class IronhammerBlockDestroyedWithToolProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity.getDirection()) == Direction.NORTH || (entity.getDirection()) == Direction.SOUTH) {
					...
					&& new Object() {
						public int getHarvestLevel(Block _bl) {
							return TierSortingRegistry.getSortedTiers().stream()
									.filter(t -> t.getTag() != null && _bl.defaultBlockState().is(t.getTag())).map(Tier::getLevel).findFirst()
									.orElse(0);
						}
					...
					if ((world.getBlockState(new BlockPos(x - 1, y + 1, z + 0))).getMaterial() == net.minecraft.world.level.material.Material.STONE
						...
						((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)).setDamageValue(
								(int) (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)).getDamageValue()
										+ 1));
						if ((world.getBlockState(new BlockPos(x + 1, y + 0, z + 0)))
								.getMaterial() == net.minecraft.world.level.material.Material.STONE && new Object() {
									public int getHarvestLevel(Block _bl) {
										return TierSortingRegistry.getSortedTiers().stream()
												.filter(t -> t.getTag() != null && _bl.defaultBlockState().is(t.getTag())).map(Tier::getLevel)
												.findFirst().orElse(0);
									}
								...
								if ((world.getBlockState(new BlockPos(x + 0, y - 1, z + 0)))
									...
									if ((world.getBlockState(new BlockPos(x + 1, y - 1, z + 0)))
											.getMaterial() == net.minecraft.world.level.material.Material.STONE && new Object() {
												public int getHarvestLevel(Block _bl) {
													return TierSortingRegistry.getSortedTiers().stream()
															.filter(t -> t.getTag() != null && _bl.defaultBlockState().is(t.getTag()))
			...
			if ((world.getBlockState(new BlockPos(x + 0, y + 1, z + 0))).getMaterial() == net.minecraft.world.level.material.Material.STONE
				...
				((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)).setDamageValue(
						(int) (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)).getDamageValue() + 1));
				if ((world.getBlockState(new BlockPos(x + 0, y + 1, z + 1))).getMaterial() == net.minecraft.world.level.material.Material.STONE
						&& new Object() {
							public int getHarvestLevel(Block _bl) {
								return TierSortingRegistry.getSortedTiers().stream()
										.filter(t -> t.getTag() != null && _bl.defaultBlockState().is(t.getTag())).map(Tier::getLevel).findFirst()
					...
					if ((world.getBlockState(new BlockPos(x - 0, y + 1, z - 1))).getMaterial() == net.minecraft.world.level.material.Material.STONE
						...
						((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)).setDamageValue(
								(int) (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)).getDamageValue()
										+ 1));
						if ((world.getBlockState(new BlockPos(x + 0, y + 0, z + 1)))
								.getMaterial() == net.minecraft.world.level.material.Material.STONE && new Object() {
									public int getHarvestLevel(Block _bl) {
										return TierSortingRegistry.getSortedTiers().stream()
												.filter(t -> t.getTag() != null && _bl.defaultBlockState().is(t.getTag())).map(Tier::getLevel)
